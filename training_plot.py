...
pref_mod_CC = np.load('working_npy/pref_mod_CC_training.npy', allow_pickle='True').item()
pref_mod_D = np.load('working_npy/pref_mod_D_training.npy', allow_pickle='True').item()
pref_mod_Y = np.load('working_npy/pref_mod_Y_training.npy', allow_pickle='True').item()
...
# plot for the preferred model

multiplot2(plain_CC, pref_mod_CC, 'Preferred Model', 'CC', 'plots/pref_mod_CC.jpg')
multiplot2(plain_D, pref_mod_D, 'Preferred Model', 'D', 'plots/pref_mod_D.jpg')
multiplot2(plain_Y,  pref_mod_Y, 'Preferred Model', 'Y', 'plots/pref_mod_Y.jpg')